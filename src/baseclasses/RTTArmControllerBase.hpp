 ...
 *
 */
class RTTArmControllerBase: public cogimon::RTTJointAwareTaskContext {
public:
	/**
...
protected:
	 ...
	 */
	bool updateDynamicsAndKinematics(
			const rstrt::kinematics::JointAngles& jPosFb,
			const rstrt::kinematics::JointVelocities& jVelFb,
